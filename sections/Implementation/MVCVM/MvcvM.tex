...
\\
The controllers are inspired by the controller component from the Model-View-Controller (MVC) pattern. \todo[inline]{Er det nødvendigt at have med == ja ( Beskriv MVC med kilder)}
