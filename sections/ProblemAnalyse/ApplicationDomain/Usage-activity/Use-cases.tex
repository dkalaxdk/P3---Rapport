...
These are the relevant use cases to manage the assets. The use cases have been placed in an actor table with the two previously mentioned actors, in order to illustrate the connections between these.
