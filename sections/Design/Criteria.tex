...
In this section, the importance of each criterion has been evaluated based on the criterion analysis model described in \cite[chap 9]{OOAD}.
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|c|}
        \hline
        \textbf{Criterion} & \textbf{Very important} & \textbf{Important} & \textbf{Less important} & \textbf{Irrelevant} & \textbf{Easily fulfilled}\\
        \hline
        \hline
        Usable & $\pmb{\times}$ & & & & \\
        \hline
