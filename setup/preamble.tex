...
%
\documentclass[11pt,twoside,a4paper,openright,usenames,dvipsnames]{report}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\definecolor{LightGray}{gray}{0.97} % Light gray
...
\usepackage[
  inner=20mm,% left margin on an odd page 28
  outer=30mm,% right margin on an odd page 41
  top=30mm,
  bottom=30mm
  ]{geometry}
